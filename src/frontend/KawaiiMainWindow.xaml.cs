...
{
    public partial class KawaiiMainWindow : Window
    {
        private readonly HttpClient _httpClient;
        private const string BackendBaseUrl = "http://localhost:8000";
        private readonly SolidColorBrush PurpleBrush = new SolidColorBrush(Color.FromRgb(106, 106, 255)); // #6A6AFF
        private readonly SolidColorBrush GreenBrush = new SolidColorBrush(Colors.SeaGreen);
        private readonly SolidColorBrush RedBrush = new SolidColorBrush(Colors.Crimson);
        private readonly SolidColorBrush YellowBrush = new SolidColorBrush(Colors.Orange);
        private readonly SolidColorBrush DarkPurpleBrush = new SolidColorBrush(Color.FromRgb(51, 51, 102)); // #333366

        public KawaiiMainWindow()
        {
            InitializeComponent();
        ...
        {
            MessageBox.Show($"导航到 {page} 页面", "功能提示", MessageBoxButton.OK, MessageBoxImage.Information);
        }

        private void SwitchToPanel(string panel)
        {
            MessageBox.Show($"切换到 {panel} 面板", "功能提示", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        private async Task SendMessage()
        {
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    {
                        AddChatMessage("🤖 NekoShizukuAI", result.response, Colors.SeaGreen);
        ...
        private void AddChatMessage(string sender, string message, Color color)
        {
            ...
            var messageText = new TextBlock
            {
                ...
                Foreground = new SolidColorBrush(Colors.Black) // 黑色文字在浅色背景下更清晰
            };
        ...
        private async Task RefreshStatus()
        {
            try
            {
                ...
                {
                    BackendStatusValue.Text = "🟢 Running";
                ...
                {
                    BackendStatusValue.Text = "🔴 Not Running";
                ...
                if (statusResponse != null)
                {
                    ...
                    {
                        OBSStatusValue.Text = "🟢 Connected";
                        OBSStatusValue.Foreground = GreenBrush;
                    }
                    else
                    {
                        OBSStatusValue.Text = "🔴 Disconnected";
                    ...
                    {
                        VTSStatusValue.Text = "🟢 Connected";
                        VTSStatusValue.Foreground = GreenBrush;
                    }
                    else
                    {
                        VTSStatusValue.Text = "🔴 Disconnected";
                    ...
                    if (healthResponse.IsSuccessStatusCode)
                    {
                        AIStatusValue.Text = "🟢 Ready";
                        AIStatusValue.Foreground = GreenBrush;
                    }
                    else
                    {
                        AIStatusValue.Text = "🔴 Not Ready";
        ...
        private void ShowNotification(string message, NotificationType type)
        {
            ...
            MessageBox.Show(message, "系统通知", MessageBoxButton.OK, icon);
        }
